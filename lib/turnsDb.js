...
export async function updateTurnForOrg(orgId, turnId, patch = {}) {
  ...
  const dbPatch = {
    ...
    open_days: Number.isFinite(Number(nextPayload.openDays)) ? Number(nextPayload.openDays) : null,
    days_in_stage: Number.isFinite(Number(nextPayload.daysInStage)) ? Number(nextPayload.daysInStage) : null,
    risk: Number.isFinite(Number(nextPayload.risk)) ? Number(nextPayload.risk) : null,
    readiness: Number.isFinite(Number(nextPayload.readiness)) ? Number(nextPayload.readiness) : null,
